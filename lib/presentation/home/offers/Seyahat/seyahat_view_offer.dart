...
class SeyahatViewOffer extends StatefulWidget {
  static const routeName = '/seyahat-presentation-offer';

  @override
  _SeyahatViewOfferState createState() => _SeyahatViewOfferState();
}

class _SeyahatViewOfferState extends State<SeyahatViewOffer> {
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 25),
                      child: Text(
                        'Size En Uygun Seyahat Sigortası Teklifleri',
                        style: D16B,
                      ),
                    ),
                    SizedBox(height: 17),
