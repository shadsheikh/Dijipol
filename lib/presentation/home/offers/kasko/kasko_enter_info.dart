...
class KaskoEnterInfo extends StatefulWidget {
  static const String routeName = '/kasko-enter-info';
...
class _KaskoEnterInfoState extends State<KaskoEnterInfo> {
  ...
  bool? isVehicleDisabilityTool;
  bool? doYouWantToInsureVehicleAccesory;
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    if (currentStep == 0)
                      Row(
                        children: <Widget>[
                          ...
                          RadioText<int>(value: 1, groupvalue: plakamRadio, onChange: (i) => setState(()=>plakamRadio = i),text:'Plakam Yok'),
                        ],
                      ),
                    if (currentStep == 0)
                      Padding(
                      ...
                      if (isStepThreeEditable)
                        Column(
                          ...
                          children: [
                            ...
                            DualTextColumn(text1: 'Model',
                                text2: '308 Allure Sport 1.2 Puretech 130 S&S EAT8'),
                            GestureDetector(
                              onTap: () {
                                setState(() {
                    ...
                    if (currentStep == 3)
                      Text(
                        'Sigortalamak İstediğiniz Araç Aksesuarı var mı?',
                        style: TextStyle(
                          color: Theme.of(context).primaryColorDark,
                          fontWeight: FontWeight.w500,
                        ),
                    ...
                    if (currentStep == 3)
                      Row(
                        children: <Widget>[
                          RadioText<bool>(value: true, groupvalue: doKnowRadioStep2, onChange: (i) => setState(()=>doKnowRadioStep2 = i),text:'Evet'),
                    ...
                    if (currentStep == 3 && (doKnowRadioStep3 ?? false))
                      Row(
                        children: <Widget>[
                          RadioText<bool>(value: true, groupvalue: isVehicleDisabilityTool, onChange: (i) => setState(()=>isVehicleDisabilityTool = i),text:'Evet'),
                          RadioText<bool>(value: false, groupvalue: isVehicleDisabilityTool, onChange: (i) => setState(()=>isVehicleDisabilityTool = i),text:'Hayır'),
                        ],
                      ),
                    if (currentStep == 3 && (doKnowRadioStep3 ?? false))
                      const SizedBox(height: 20),
                    ...
                    if (currentStep == 3 && (doKnowRadioStep3 ?? false))
                      Row(
                        children: <Widget>[
                          RadioText<bool>(value: true, groupvalue: doYouWantToInsureVehicleAccesory, onChange: (i) => setState(()=>doYouWantToInsureVehicleAccesory = i),text:'Evet'),
                          RadioText<bool>(value: false, groupvalue: doYouWantToInsureVehicleAccesory, onChange: (i) => setState(()=>doYouWantToInsureVehicleAccesory = i),text:'Hayır'),
                        ],
                      ),
                    if (currentStep == 3 && (doKnowRadioStep3 ?? false))
                      const SizedBox(height: 20),
                    ...
                    if (currentStep == 3)
                      AppButton(
                        ...
                        disabled: doKnowRadioStep3 ?? false
                            ? isVehicleDisabilityTool == null ||
                                doYouWantToInsureVehicleAccesory == null
                            : doKnowRadioStep3 == null,
                        onTap: () {
                          Navigator.of(context)
                              .pushNamed(KaskoRequestReceived.routeName);
                        },
                      ),
                    const SizedBox(height: 20),
                  ],
