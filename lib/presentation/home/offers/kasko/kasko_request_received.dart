...
class KaskoRequestReceived extends StatelessWidget {
  static const String routeName = '/kasko-request-received';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AppButton(
                      text: 'Anasayfaya Dön',
                      onTap: () {
                        Navigator.pushNamed(context, KaskoViewOffer.routeName);
                      },
                    ),
                  ],
                ),
