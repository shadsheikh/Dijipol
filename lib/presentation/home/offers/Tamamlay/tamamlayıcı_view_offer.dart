...
class TamamlayViewOffer extends StatefulWidget {
  static const routeName = '/tamamlay-presentation-offer';

  @override
  _TamamlayViewOfferState createState() => _TamamlayViewOfferState();
}

class _TamamlayViewOfferState extends State<TamamlayViewOffer> {
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 25),
                      child: Text(
                        'Size En Uygun Tamamlayıcı Sağlık Sigortası Teklifleri',
                        style: D16B,
                      ),
                    ),
                    SizedBox(height: 17),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DualTextColumn(
                                text1: 'Eşinizin Adı ve Soyadı',
                                text2: 'Kader  Kızılay'),
                            DualTextColumn(
                                text1: 'TC Kimlik No', text2: '502332030332'),
                            DualTextColumn(
                                text1: '1.Çocuk Adı ve Soyadı',
                                text2: '502332030332'),
                            DualTextColumn(
                                text1: 'TC Kimlik No', text2: '502332030332'),
                            GestureDetector(
