...
import 'arac_insurance_offer.dart';
import 'package:dijipol/presentation/widgets/custom_widgets.dart';

class AracViewOffer extends StatefulWidget {
  static const routeName = '/arac-presentation-offer';

  @override
  _AracViewOfferState createState() => _AracViewOfferState();
}

class _AracViewOfferState extends State<AracViewOffer> {
