...
class CepEnterInfo extends StatefulWidget {
  static const String routeName = '/cep-enter-info';

  @override
  _CepEnterInfoState createState() => _CepEnterInfoState();
}

class _CepEnterInfoState extends State<CepEnterInfo> {
  int plakamRadio = 0;
  int currentStep = 0;
                  ...
                  children: <Widget>[
                    ...
                    if (currentStep == 0 && plakamRadio == 1)
                      Column(
                        ...
                        children: [
                          AppTextInput(
                            label: 'Eski Cep Poliçe Numaranız',
                            placeholder: '12342323',
                            fontSize: 14,
                          ),
                          SizedBox(height: 25),
                          Text('Cep Poliçe Numaramı Bilmiyorum' ,style: P16M),
                        ],
                      ),
                      ...
                      AppButton(
                        ...
                        onTap: () {
                          Navigator.of(context)
                              .pushNamed(CepRequestReceived.routeName);
                          setState(() {
                            currentStep = 3;
                          });
                        },
