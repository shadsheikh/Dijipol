...
class CepHomeScreen extends StatefulWidget {
  static const String routeName = '/cep-home';

  @override
  _CepHomeScreenState createState() => _CepHomeScreenState();
}

class _CepHomeScreenState extends State<CepHomeScreen> {
