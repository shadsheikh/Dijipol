...
class DaskRequestReceived extends StatelessWidget {
  static const String routeName = '/dask-request-received';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AppButton(
                      text: 'Anasayfaya Dön',
                      onTap: () {
                        Navigator.pushNamed(context, DaskViewOffer.routeName);
                      },
                    ),
                  ],
                ),
