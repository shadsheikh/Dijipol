...
class KnoutViewOffer extends StatefulWidget {
  static const routeName = '/knout-presentation-offer';

  @override
  _KnoutViewOfferState createState() => _KnoutViewOfferState();
}

class _KnoutViewOfferState extends State<KnoutViewOffer> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 25),
                      child: Text(
                        'Size En Uygun Knout Sigortası Teklifleri',
                        style: D16B,
                      ),
                    ),
                    SizedBox(height: 17),
