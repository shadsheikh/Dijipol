...
class KnoutHomeScreen extends StatefulWidget {
  static const String routeName = '/knout-home';

  @override
  _KnoutHomeScreenState createState() => _KnoutHomeScreenState();
}

class _KnoutHomeScreenState extends State<KnoutHomeScreen> {
